...
import com.girl.video.constant.MsgConstant;
import com.girl.video.constant.SystemConstant;
...
public class CommonUtils {
	...
	public static R appMsg(Object data){
        if(isNullOrEmpty(data)){
            return R.error(MsgConstant.APP_MSG);
        }
        return R.ok().put(SystemConstant.DATA_ROWS, data);
    }
